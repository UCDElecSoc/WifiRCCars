...
// Motor pins (as verified by your test)
...
void applyMotors() {
  applyMotorSide(leftSpeed, IN2, IN1);  // forward pin = IN2, reverse pin = IN1
  applyMotorSide(rightSpeed, IN4, IN3); // forward pin = IN4, reverse pin = IN3
}
